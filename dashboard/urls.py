...
urlpatterns=[
    ...
    path("add_certification/", add_certification_view, name="certification-add"),
    path("view_certification/",view_certification_view,name="certification-view"),
    path("edit_certification/<int:pk>", edit_certification_view, name="certification-edit"),
    path("delete_certification/<int:pk>", delete_certification_view, name="certification-delete"),
    path("add_education/", add_education_view, name="education-add"),
    path("view_education/",view_education_view,name="education-view"),
    path("edit_education/<int:pk>", edit_education_view, name="education-edit"),
    path("delete_education/<int:pk>", delete_education_view, name="education-delete"),
